...
import { isRouteActive } from '~/lib/hooks/is-route-active';
...
import { If } from './if';
import type { NavigationConfigSchema } from '~/lib/schemas/navigation-config.schema';
...
export function SidebarGroup({
  ...
  const titleNode = sidebarCollapsed ? null : (
  ...
  const header = collapsible ? (
    ...
    <div className={headerClassName}>{titleNode}</div>
  );
